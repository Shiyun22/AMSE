...
class Exercise2aPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Exercice 2a')),
      body: Center(child: Text("Contenu de l'exercice 2a ici")),
    );
  }
}

class Exercise2bPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Exercice 2b')),
      body: Center(child: Text("Contenu de l'exercice 2b ici")),
    );
  }
}
...
// ==============
// 主页面组件（修正后的StatefulWidget）
// ==============
class Exercise6Page extends StatefulWidget {
  @override
  _Exercise6PageState createState() => _Exercise6PageState(); // 修正点1：返回正确的State类
}
